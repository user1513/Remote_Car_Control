...
extern float VelocityA_KP, VelocityA_KI;	          		//速度控制PID参数
extern float VelocityB_KP, VelocityB_KI;	          		//速度控制PID参数
extern float VelocityC_KP, VelocityC_KI;	          		//速度控制PID参数
extern float VelocityD_KP, VelocityD_KI;	          		//速度控制PID参数
